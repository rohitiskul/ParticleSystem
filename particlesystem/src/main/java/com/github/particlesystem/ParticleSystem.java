package com.github.particlesystem;
...
import com.github.particlesystem.initializers.AccelerationInitializer;
import com.github.particlesystem.initializers.ParticleInitializer;
import com.github.particlesystem.initializers.RotationInitiazer;
import com.github.particlesystem.initializers.RotationSpeedInitializer;
import com.github.particlesystem.initializers.ScaleInitializer;
import com.github.particlesystem.initializers.SpeeddByComponentsInitializer;
import com.github.particlesystem.initializers.SpeeddModuleAndRangeInitializer;
import com.github.particlesystem.modifiers.AlphaModifier;
import com.github.particlesystem.modifiers.ParticleModifier;
...
public class ParticleSystem {
    ...
    private ParticleSystem(Context context, int maxParticles, long timeToLive, ViewGroup parentView) {
        mRandom = new Random();
    ...
    public ParticleSystem(Activity a, int maxParticles, int drawableRedId, long timeToLive) {
        this(a, maxParticles, a.getResources().getDrawable(drawableRedId), timeToLive, (ViewGroup) a.findViewById(android.R.id.content));
    }
     ...
     * @param drawableRedId The drawable resource to use as particle (supports Bitmaps and Animations)
     * @param timeToLive    The time to live for the particles
     * @param parentView    The view Id for the parent of the particle system
     */
    public ParticleSystem(Context context, int maxParticles, int drawableRedId, long timeToLive, ViewGroup parentView) {
        this(context, maxParticles, context.getResources().getDrawable(drawableRedId), timeToLive, parentView);
    }
    ...
    public ParticleSystem(Activity a, int maxParticles, Drawable drawable, long timeToLive) {
        this(a, maxParticles, drawable, timeToLive, (ViewGroup) a.findViewById(android.R.id.content));
    }
    ...
    public ParticleSystem(Activity a, int maxParticles, Bitmap bitmap, long timeToLive) {
        this(a, maxParticles, bitmap, timeToLive, (ViewGroup) a.findViewById(android.R.id.content));
    }
    ...
    public ParticleSystem(Activity a, int maxParticles, AnimationDrawable animation, long timeToLive) {
        this(a, maxParticles, animation, timeToLive, (ViewGroup) a.findViewById(android.R.id.content));
    }
     ...
     * @param parentView   The view Id for the parent of the particle system
     */
    public ParticleSystem(Context context, int maxParticles, AnimationDrawable animation, long timeToLive, ViewGroup parentView) {
        this(context, maxParticles, timeToLive, parentView);
        // Create the particles
        for (int i = 0; i < mMaxParticles; i++) {
            mParticles.add(new AnimatedParticle(animation));
